...
def run(images):
    ...
    for num, im in enumerate(images):
        ...
        j+=1
    emoj=Image.open(r".\fire.png")#Emoji or any other png file like your logo or any other sorts
    ...
    draw.text((150,280), "Test you want to insert in thumnail", font=font,fill=(255,20,20,100))#like XMillion views ..
    new_im.show()
